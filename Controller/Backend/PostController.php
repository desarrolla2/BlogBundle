...
class PostController extends Controller
{
     ...
     *
     * @Route("/new", name="_blog_back_post_new")
     * @Template()
     */
     ...
     *
     * @Route("/create", name="_blog_back_post_create")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/edit", name="_blog_back_post_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/update", name="_blog_back_post_update")
     * @Method("POST")
    ...
    public function updateAction($id)
    {
        ...
        if ($formHandler->process()) {
            return $this->redirect($this->generateUrl('_blog_back_post'));
        }
     ...
     *
     * @Route("/{id}/delete", name="_blog_back_post_delete")
     * @Method("POST")
     */
     ...
     * Publish a Post
     *
     * @Route("/{id}/publish", name="_blog_back_post_publish")
     */
     ...
     * Unpublish a Post
     *
     * @Route("/{id}/unpublish", name="_blog_back_post_unpublish")
     */
    ...
    /**
     *
     * @Route("/{id}/preview" , name="_blog_back_post_preview")
     * @Method({"GET"})
     * @Template()
     */
