...
class CommentController extends Controller
{
     ...
     *
     * @Route("/create", name="_blog_backend_comment_create")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/edit", name="_blog_backend_comment_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/update", name="_blog_backend_comment_update")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/delete", name="_blog_backend_comment_delete")
     * @Method("POST")
     */
     ...
     * Publish a Comment
     *
     * @Route("/{id}/publish", name="_blog_backend_comment_publish")
     */
     ...
     * Unpublish a Comment
     *
     * @Route("/{id}/unpublish", name="_blog_backend_comment_unpublish")
     */
